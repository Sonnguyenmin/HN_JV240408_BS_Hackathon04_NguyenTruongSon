...
public class Product implements  Comparable<Product>{
    ...
    public boolean inputStatus(Scanner scanner) {
        ...
        do {
            String productStatus = scanner.nextLine().toLowerCase();
            if (productStatus.equals("true") || productStatus.equals("false")) {
                return Boolean.parseBoolean(scanner.nextLine());
            } else  {
                System.err.println("Trạng thái tác giả chỉ nhận giá trị true | false, vui lòng nhập lại");
            }
        }
        while (true);
    }
    ...
    public String toString() {
        return "Product{" +
                ...
                ", status=" + (this.status ? "bán" : "Không bán") +
                '}';
    }
